                ...
                createElementBlock(
                    'div',
                    {
                        ...
                        class: normalizeClass([
                            unref(icon),
                            unref(isDark) ? '' : 'brightness-60 hue-rotate-180 invert-100 saturate-200',
                        ]),
                    },
                    null,
                    2
...
async function detectOverflow(state, options) {
    ...
    const clippingClientRect = rectToClientRect(
        await platform.getClippingRect({
            element: (
                (_await$platform$isEle = await (platform.isElement == null ? void 0 : platform.isElement(element))) !=
                null
                ...
                .map((d$2) => {
                    ...
                    return [
                        ...
                        alignment$1 && crossAxis
                            ? d$2.overflows.slice(0, 2).reduce((acc, v$1) => acc + v$1, 0)
                            : d$2.overflows[0],
                        d$2.overflows,
                    ];
                })
                .sort((a$1, b$2) => a$1[1] - b$2[1]);
            const placementsThatFitOnEachSide = placementsSortedByMostSpace.filter((d$2) =>
                d$2[2]
                    .slice(
                        0,
    ...
    return {
        ...
        async fn(state) {
            ...
            if (!overflows.every((side$1) => side$1 <= 0)) {
                ...
                const nextIndex =
                    (((_middlewareData$flip2 = middlewareData.flip) == null ? void 0 : _middlewareData$flip2.index) ||
                        0) + 1;
                ...
                let resetPlacement =
                    (_overflowsData$filter = overflowsData
                        .filter((d$2) => d$2.overflows[0] <= 0)
                        .sort((a$1, b$2) => a$1.overflows[1] - b$2.overflows[1])[0]) == null
                        ? void 0
                        ...
                        case 'bestFit': {
                            ...
                            const placement$1 =
                                (_overflowsData$filter2 = overflowsData
                                    ...
                                    .sort((a$1, b$2) => a$1[1] - b$2[1])[0]) == null
                                    ? void 0
    ...
    return {
        ...
        async fn(state) {
            ...
            if (side === 'top' || side === 'bottom') {
                ...
                widthSide =
                    alignment ===
                    ((await (platform.isRTL == null ? void 0 : platform.isRTL(elements.floating))) ? 'start' : 'end')
                        ? 'left'
                        : 'right';
            } else {
                widthSide = side;
...
function c$1(t) {
    const e = o(t);
    let n$2 = parseFloat(e.width),
        i$1 = parseFloat(e.height);
    const r$1 = t.offsetWidth,
        c$2 = t.offsetHeight,
        s$1 = l(n$2) !== r$1 || l(i$1) !== c$2;
    return (
        s$1 && ((n$2 = r$1), (i$1 = c$2)),
        {
            width: n$2,
...
function u() {
    ...
    return t && Array.isArray(t.brands)
        ? ((f = t.brands.map((t$1) => t$1.brand + '/' + t$1.version).join(' ')), f)
        : navigator.userAgent;
}
function a(t) {
...
function y$1(t) {
    const e = /firefox/i.test(u()),
        n$2 = o(t),
        i$1 = n$2.backdropFilter || n$2.WebkitBackdropFilter;
    return (
        'none' !== n$2.transform ||
        'none' !== n$2.perspective ||
        (!!i$1 && 'none' !== i$1) ||
        (e && 'filter' === n$2.willChange) ||
        (e && !!n$2.filter && 'none' !== n$2.filter) ||
        ['transform', 'perspective'].some((t$1) => n$2.willChange.includes(t$1)) ||
        ['paint', 'layout', 'strict', 'content'].some((t$1) => {
...
function L(t) {
    const e = v(t);
    if (!a(e)) return b$1;
    const n$2 = e.getBoundingClientRect(),
        { width: o$1, height: i$1, fallback: r$1 } = c$1(e);
    let s$1 = (r$1 ? l(n$2.width) : n$2.width) / o$1,
        f$1 = (r$1 ? l(n$2.height) : n$2.height) / i$1;
    return (
        (s$1 && Number.isFinite(s$1)) || (s$1 = 1),
        (f$1 && Number.isFinite(f$1)) || (f$1 = 1),
        {
            x: s$1,
            y: f$1,
        }
...
function E$1(t, e, o$1, i$1) {
    ...
    const c$2 = t.getBoundingClientRect(),
        s$1 = v(t);
    let f$1 = b$1;
    e && (i$1 ? d$1(i$1) && (f$1 = L(i$1)) : (f$1 = L(t)));
    const u$1 = s$1 ? n$1(s$1) : window,
        a$1 = !x$1() && o$1;
    let h$3 = (c$2.left + ((a$1 && (null == (r$1 = u$1.visualViewport) ? void 0 : r$1.offsetLeft)) || 0)) / f$1.x,
        p$1 = (c$2.top + ((a$1 && (null == (l$1 = u$1.visualViewport) ? void 0 : l$1.offsetTop)) || 0)) / f$1.y,
        g$2 = c$2.width / f$1.x,
        m$2 = c$2.height / f$1.y;
    if (s$1) {
        const t$1 = n$1(s$1),
            e$1 = i$1 && d$1(i$1) ? n$1(i$1) : i$1;
        let o$2 = t$1.frameElement;
        for (; o$2 && i$1 && e$1 !== t$1; ) {
            const t$2 = L(o$2),
                e$2 = o$2.getBoundingClientRect(),
                i$2 = getComputedStyle(o$2);
            (e$2.x += (o$2.clientLeft + parseFloat(i$2.paddingLeft)) * t$2.x),
                (e$2.y += (o$2.clientTop + parseFloat(i$2.paddingTop)) * t$2.y),
                (h$3 *= t$2.x),
                (p$1 *= t$2.y),
                (g$2 *= t$2.x),
                (m$2 *= t$2.y),
...
function D(t, e) {
    ...
    void 0 === e && (e = []);
    const i$1 = W(t),
        r$1 = i$1 === (null == (o$1 = t.ownerDocument) ? void 0 : o$1.body),
        l$1 = n$1(i$1);
    ...
    return 'viewport' === i$1
        ? rectToClientRect(
              (function (t, e$1) {
                  const o$1 = n$1(t),
                      i$2 = R(t),
                      r$1 = o$1.visualViewport;
                  let l$2 = i$2.clientWidth,
                      c$2 = i$2.clientHeight,
                      s$1 = 0,
                      f$1 = 0;
                  if (r$1) {
        ...
        : d$1(i$1)
          ? rectToClientRect(
                (function (t, e$1) {
                    const n$2 = E$1(t, !0, 'fixed' === e$1),
                        o$1 = n$2.top + t.clientTop,
                        i$2 = n$2.left + t.clientLeft,
                        r$1 = a(t)
                            ? L(t)
                            : {
                                  x: 1,
          ...
          : rectToClientRect(
                (function (t) {
                    const e$1 = R(t),
                        n$2 = T(t),
                        i$2 = t.ownerDocument.body,
                        l$2 = r(e$1.scrollWidth, e$1.clientWidth, i$2.scrollWidth, i$2.clientWidth),
                        c$2 = r(e$1.scrollHeight, e$1.clientHeight, i$2.scrollHeight, i$2.clientHeight);
                    let s$1 = -n$2.scrollLeft + C$1(t);
                    const f$1 = -n$2.scrollTop;
                    return (
                        'rtl' === o(i$2).direction && (s$1 += r(e$1.clientWidth, i$2.clientWidth) - l$2),
                        {
                            width: l$2,
                            height: c$2,
                            x: s$1,
...
function H$1(t) {
    ...
    return i$1 && ('html' === s(i$1) || ('body' === s(i$1) && 'static' === o(i$1).position && !y$1(i$1)))
        ? e
        : i$1 ||
              (function (t$1) {
                  let e$1 = F(t$1);
...
function O(t, e, n$2) {
    ...
    if (o$1 || (!o$1 && 'fixed' !== n$2))
        if ((('body' !== s(e) || g$1(i$1)) && (l$1 = T(e)), a(e))) {
            const t$1 = E$1(e, !0);
...
const P = {
    getClippingRect: function (t) {
        ...
        const f$1 =
                'clippingAncestors' === n$2
                    ? (function (t$1, e$1) {
                          const n$3 = e$1.get(t$1);
                          if (n$3) return n$3;
                          let i$1 = D(t$1).filter((t$2) => d$1(t$2) && 'body' !== s(t$2)),
                              r$1 = null;
                              ...
                              (
                                  l$2
                                      ...
                                      : e$2 ||
                                        'static' !== t$2.position ||
                                        !r$1 ||
                                        !['absolute', 'fixed'].includes(r$1.position)
                              )
                                  ? (r$1 = t$2)
                                  : (i$1 = i$1.filter((t$3) => t$3 !== c$3)),
                                  (c$3 = F(c$3));
                          }
            ...
            h$3 = u$1.reduce(
                (t$1, n$3) => {
                    ...
                    return (
                        (t$1.top = r(o$1.top, t$1.top)),
                        (t$1.right = i(o$1.right, t$1.right)),
                        (t$1.bottom = i(o$1.bottom, t$1.bottom)),
                        (t$1.left = r(o$1.left, t$1.left)),
                        t$1
                    );
                },
                S$1(e, a$1, c$2)
    ...
    async getElementRects(t) {
        ...
        const i$1 = this.getOffsetParent || H$1,
            r$1 = this.getDimensions;
        return {
...
function Ze(e) {
    const t = [e];
    let o$1 = h$1.themes[e] || {};
    do o$1.$extend && !o$1.$resetCss ? (t.push(o$1.$extend), (o$1 = h$1.themes[o$1.$extend] || {})) : (o$1 = null);
    while (o$1);
...
function re(e) {
    const t = [e];
    let o$1 = h$1.themes[e] || {};
    do o$1.$extend ? (t.push(o$1.$extend), (o$1 = h$1.themes[o$1.$extend] || {})) : (o$1 = null);
    while (o$1);
    return t;
}
let $ = !1;
...
typeof window < 'u' &&
    typeof navigator < 'u' &&
    (_e = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream);
const Te = ['auto', 'top', 'bottom', 'left', 'right'].reduce((e, t) => e.concat([t, `${t}-start`, `${t}-end`]), []),
    pe = {
        hover: 'mouseenter',
        focus: 'focus',
        click: 'click',
...
const q = '__floating-vue__popper',
    Q = () =>
        defineComponent({
            name: 'VPopper',
            provide() {
            ...
            methods: {
                show({ event: e = null, skipDelay: t = !1, force: o$1 = !1 } = {}) {
                    var i$1, s$1;
                    ((i$1 = this.parentPopper) != null && i$1.lockedChild && this.parentPopper.lockedChild !== this) ||
                        ((this.pendingHide = !1),
                        (o$1 || !this.disabled) &&
                            (((s$1 = this.parentPopper) == null ? void 0 : s$1.lockedChild) === this &&
                ...
                hide({ event: e = null, skipDelay: t = !1 } = {}) {
                    ...
                    if (!this.$_hideInProgress) {
                        ...
                        ((o$1 = this.parentPopper) == null ? void 0 : o$1.lockedChild) === this &&
                            (this.parentPopper.lockedChild = null),
                            (this.pendingHide = !1),
                ...
                async $_computePosition() {
                    ...
                    if (
                        (t
                            ? e.middleware.push(autoPlacement({ alignment: this.placement.split('-')[1] ?? '' }))
                        ...
                        this.arrowOverflow &&
                            e.middleware.push({
                                ...
                                fn: ({ placement: i$1, rects: s$1, middlewareData: r$1 }) => {
                                    ...
                                    return (
                                        i$1.startsWith('top') || i$1.startsWith('bottom')
                                            ? (p$1 = Math.abs(a$1) > s$1.reference.width / 2)
                                            : (p$1 = Math.abs(a$1) > s$1.reference.height / 2),
                                        { data: { overflow: p$1 } }
                                    );
                                },
                            }),
                        ...
                        e.middleware.push({
                            ...
                            fn: ({ rects: s$1, placement: r$1, middlewareData: p$1 }) => {
                                ...
                                let a$1, l$1;
                                return (
                                    r$1.startsWith('top') || r$1.startsWith('bottom')
                                        ? (a$1 = s$1.reference.width)
                                        : (l$1 = s$1.reference.height),
                                    (this.$_innerNode.style[
                                        i$1 === 'min' ? 'minWidth' : i$1 === 'max' ? 'maxWidth' : 'width'
                                    ] = a$1 != null ? `${a$1}px` : null),
                                    (this.$_innerNode.style[
                                        i$1 === 'min' ? 'minHeight' : i$1 === 'max' ? 'maxHeight' : 'height'
                                    ] = l$1 != null ? `${l$1}px` : null),
                                    {
                                        data: { skip: !0 },
                                        reset: { rects: !0 },
                                    }
                        ...
                        e.middleware.push(
                            size({
                                ...
                                apply: ({ availableWidth: i$1, availableHeight: s$1 }) => {
                                    (this.$_innerNode.style.maxWidth = i$1 != null ? `${i$1}px` : null),
                                        (this.$_innerNode.style.maxHeight = s$1 != null ? `${s$1}px` : null);
                                },
                            })
                        ));
                ...
                $_scheduleShow(e, t = !1) {
                    if (
                        ...
                        g && this.instantMove && g.instantMove && g !== this.parentPopper)
                    ) {
                        ...
                        !this.isShown &&
                            ...
                            this.positioningDisabled ||
                                this.$_registerEventListeners(
                                    [...D(this.$_referenceNode), ...D(this.$_popperNode)],
                                    'scroll',
                                    () => {
                ...
                async $_applyShowEffect() {
                    ...
                    if (this.computeTransformOrigin) {
                        const t = this.$_referenceNode.getBoundingClientRect(),
                            o$1 = this.$_popperNode.querySelector('.v-popper__wrapper'),
                            i$1 = o$1.parentNode.getBoundingClientRect(),
                            s$1 = t.x + t.width / 2 - (i$1.left + o$1.offsetLeft),
                            r$1 = t.y + t.height / 2 - (i$1.top + o$1.offsetTop);
                    ...
                    if (e) {
                        let t;
                        for (let o$1 = 0; o$1 < d.length; o$1++)
                            (t = d[o$1]), t.showGroup !== e && (t.hide(), t.$emit('close-group'));
                    }
                ...
                async $_applyHide(e = !1) {
                    ...
                    (this.skipTransition = e),
                        de(d, this),
                        d.length === 0 && document.body.classList.remove('v-popper--some-open');
                    for (const o$1 of re(this.theme)) {
                        const i$1 = he(o$1);
                        de(i$1, this),
                            i$1.length === 0 && document.body.classList.remove(`v-popper--some-open--${o$1}`);
                    }
                    g === this && (g = null),
                        (this.isShown = !1),
                        this.$_applyAttrsToTarget({
                ...
                $_addEventListeners() {
                    const e = (o$1) => {
                        (this.isShown && !this.$_hideInProgress) ||
                            ((o$1.usedByTooltip = !0), !this.$_preventShow && this.show({ event: o$1 }));
                    };
                    this.$_registerTriggerListeners(this.$_targetNodes, pe, this.triggers, this.showTriggers, e),
                    ...
                    this.$_registerTriggerListeners(this.$_targetNodes, ae, this.triggers, this.hideTriggers, t),
                        this.$_registerTriggerListeners(
                            [this.$_popperNode],
                            ae,
                            this.popperTriggers,
                ...
                $_registerTriggerListeners(e, t, o$1, i$1, s$1) {
                    let r$1 = o$1;
                    i$1 != null && (r$1 = typeof i$1 == 'function' ? i$1(r$1) : i$1),
                        r$1.forEach((p$1) => {
                            const a$1 = t[p$1];
                ...
                $_isAimingPopper() {
                    ...
                    if (y >= e.left && y <= e.right && _ >= e.top && _ <= e.bottom) {
                        const t = this.$_popperNode.getBoundingClientRect(),
                            o$1 = y - c,
                            i$1 = _ - m,
                            r$1 = t.left + t.width / 2 - c + (t.top + t.height / 2) - m + t.width + t.height,
                            p$1 = c + o$1 * r$1,
                            a$1 = m + i$1 * r$1;
                        return (
                            C(c, m, p$1, a$1, t.left, t.top, t.left, t.bottom) ||
                            C(c, m, p$1, a$1, t.left, t.top, t.right, t.top) ||
                            C(c, m, p$1, a$1, t.right, t.top, t.right, t.bottom) ||
                            C(c, m, p$1, a$1, t.left, t.bottom, t.right, t.bottom)
                        );
                    }
                    return !1;
                },
...
if (typeof document < 'u' && typeof window < 'u') {
    if (_e) {
        const e = $
            ...
            : !0;
        document.addEventListener('touchstart', (t) => ue(t, !0), e),
            document.addEventListener('touchend', (t) => fe(t, !0), e);
    } else
        window.addEventListener('mousedown', (e) => ue(e, !1), !0),
            window.addEventListener('click', (e) => fe(e, !1), !0);
...
function C(e, t, o$1, i$1, s$1, r$1, p$1, a$1) {
    const l$1 =
            ((p$1 - s$1) * (t - r$1) - (a$1 - r$1) * (e - s$1)) / ((a$1 - r$1) * (o$1 - e) - (p$1 - s$1) * (i$1 - t)),
        u$1 = ((o$1 - e) * (t - r$1) - (i$1 - t) * (e - s$1)) / ((a$1 - r$1) * (o$1 - e) - (p$1 - s$1) * (i$1 - t));
...
const Z = (e = 'theme') => ({
    ...
    ut = /* @__PURE__ */ createBaseVNode('div', { class: 'v-popper__arrow-outer' }, null, -1),
    ft = /* @__PURE__ */ createBaseVNode('div', { class: 'v-popper__arrow-inner' }, null, -1),
    ct = [ut, ft];
                                ...
                                e.mounted
                                    ? (openBlock(),
                                      createElementBlock(
                                          ...
                                          { key: 0 },
                                          [
                                              createBaseVNode('div', null, [renderSlot(e.$slots, 'default')]),
                                              e.handleResize
                                                  ? (openBlock(),
                                                    createBlock(p$1, {
                                                        key: 0,
...
const ee = /* @__PURE__ */ B(dt, [['render', mt]]),
    te = {
        methods: {
            show(...e) {
...
function wt(e, t, o$1, i$1, s$1, r$1) {
    const p$1 = resolveComponent('PopperContent'),
        a$1 = resolveComponent('Popper');
    return (
        openBlock(),
        createBlock(
            a$1,
...
const ze = /* @__PURE__ */ B($t, [['render', _t]]),
...
function Ne(e, t, o$1) {
    ...
    const s$1 = typeof t;
    return (
        s$1 === 'string' ? (i$1 = { content: t }) : t && s$1 === 'object' ? (i$1 = t) : (i$1 = { content: !1 }),
        (i$1.placement = Tt(i$1, o$1)),
        (i$1.targetNodes = () => [e]),
        (i$1.referenceNode = () => e),
        i$1
    );
...
function bt(e, t, o$1) {
    ...
    return (
        b.value.push(r$1),
        e.classList && e.classList.add(Ae),
        (e.$_popper = {
            options: i$1,
            item: r$1,
            show() {
...
function me(e, { value: t, modifiers: o$1 }) {
    ...
    if (!i$1.content || S(i$1.theme || 'tooltip', 'disabled')) He(e);
        ...
        let s$1;
        e.$_popper ? ((s$1 = e.$_popper), (s$1.options.value = i$1)) : (s$1 = bt(e, t, o$1)),
            typeof t.shown < 'u' &&
                t.shown !== e.$_popperOldShown &&
                ((e.$_popperOldShown = t.shown), t.shown ? s$1.show() : s$1.hide());
    }
}
const oe = {
    beforeMount: me,
...
function ge(e) {
    e.addEventListener('mousedown', H),
        ...
        e.addEventListener('touchstart', Oe, $ ? { passive: !0 } : !1);
}
function we(e) {
    e.removeEventListener('mousedown', H),
        e.removeEventListener('click', H),
        e.removeEventListener('touchstart', Oe),
        e.removeEventListener('touchend', Me),
        e.removeEventListener('touchcancel', Be);
}
function H(e) {
...
function Me(e) {
    ...
    if (((t.$_vclosepopover_touch = !1), e.changedTouches.length === 1)) {
        const o$1 = e.changedTouches[0],
            i$1 = t.$_vclosepopover_touchPoint;
        (e.closePopover = Math.abs(o$1.screenY - i$1.screenY) < 20 && Math.abs(o$1.screenX - i$1.screenX) < 20),
            (e.closeAllPopover = t.$_closePopoverModifiers && !!t.$_closePopoverModifiers.all);
    }
}
function Be(e) {
        ...
        const HighlightedPath = defineComponent({
            render() {
                ...
                parts.forEach((part, index) => {
                    ...
                    if (type === 'query')
                        if (part === '?' || part === '&') _class.push('text-orange-5 dark:text-orange-4');
...
var ModuleList_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        const { list, containerProps, wrapperProps } = useVirtualList(toRef(props, 'modules'), {
                      ...
                      !_ctx.modules.length
                          ? (openBlock(),
                            createElementBlock('div', _hoisted_2, [
                                unref(options).search.text
                                    ? (openBlock(), createElementBlock('div', _hoisted_3, ' No search result '))
                                    : (openBlock(),
                                      createElementBlock(
                                          'div',
                                          _hoisted_4,
                          ...
                          : (openBlock(),
                            createElementBlock(
                                'div',
                                mergeProps({ key: 1 }, unref(containerProps), { class: 'h-full' }),
                                [
                                    createBaseVNode(
                                        'div',
                                        normalizeProps(guardReactiveProps(unref(wrapperProps))),
                                        [
                                            (openBlock(true),
                                            createElementBlock(
                                                Fragment,
                                                null,
                                                renderList(unref(list), (m$2) => {
                                                    return (
                                                        openBlock(),
                                                        createBlock(
                                                            ...
                                                            },
                                                            {
                                                                default: withCtx(() => [
                                                                    ...
                                                                    unref(options).view.listMode === 'detailed'
                                                                        ? (openBlock(),
