...
import { isDark, toggleDark, usePayloadStore } from './payload-BKj06nBe.js';
...
var PluginName_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        const props = __props;
        const startsGeneric = ['__load__', 'vite-plugin-', 'vite-', 'rollup-plugin-', 'rollup-', 'unplugin-'];
    ...
    setup(__props) {
        ...
        return (_ctx, _cache) => {
            return (
                openBlock(),
                createBlock(
                    resolveDynamicComponent(_ctx.as || 'span'),
                    {
                        'ws-nowrap': '',
                        rounded: '',
...
var NavBar_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _cache) => {
            return (
                openBlock(),
                createElementBlock('nav', _hoisted_1$2, [
                    renderSlot(_ctx.$slots, 'default'),
                    renderSlot(_ctx.$slots, 'actions', {}, () => [
                        !unref(payload).metadata.embedded
                            ? (openBlock(),
                              createElementBlock(
                                  Fragment,
                                  { key: 0 },
                                ...
                                createBlock(
                                    _component_Badge,
                                    {
                                        ...
                                        class: normalizeClass([
                                            ...
                                            option.value === _ctx.modelValue ? '' : 'op50',
                                        ]),
                                    ...
                                    null,
                                    8,
                                    ['class', 'color', 'aria-pressed', 'text', 'onClick']
                                )
                            );
                        }),
                        128
        ...
        return (_ctx, _cache) => {
            ...
            return (
                ...
                createElementBlock('div', _hoisted_1, [
                    unref(payload).metadata.instances.length > 1
                        ? (openBlock(),
                          createBlock(
                              _component_SegmentControl,
                              {
                                  key: 0,
                                  modelValue: unref(payload).query.vite,
                                  'onUpdate:modelValue':
                                      _cache[0] || (_cache[0] = ($event) => (unref(payload).query.vite = $event)),
                    ...
                    createVNode(
                        _component_SegmentControl,
                        {
                            ...
                            'onUpdate:modelValue':
                                _cache[1] || (_cache[1] = ($event) => (unref(payload).query.env = $event)),
