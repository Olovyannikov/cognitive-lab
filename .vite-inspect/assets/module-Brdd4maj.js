import { __commonJSMin, __toESM, getHot } from './hot-C38Zn4iD.js';
import {
    Fragment,
    computed,
    createBaseVNode,
...
import { useRoute, useRouter, vShow } from './vue-router-DP5m7_x8.js';
import {
    guessMode,
    inspectSourcemaps,
    isStaticMode,
...
import {
    ...
    NavBar_default,
    PluginName_default,
    QuerySelector_default,
} from './QuerySelector-CM_pgBDK.js';
import { DurationDisplay_default, useOptionsStore } from './options-C60pcttb.js';
import { ModuleId_default, ModuleList_default, kt } from './ModuleList-DVacKD_e.js';
const Pe = {
        __name: 'splitpanes',
        props: {
            horizontal: {
        ...
        setup(D, { emit: h$1 }) {
            const y = h$1,
                ...
                R = () => {
                    document.addEventListener('mousemove', r, { passive: !1 }),
                ...
                O = () => {
                    document.removeEventListener('mousemove', r, { passive: !1 }),
                        document.removeEventListener('mouseup', P),
                        'ontouchstart' in window &&
                            (document.removeEventListener('touchmove', r, { passive: !1 }),
                ...
                b = (e, n) => {
                    ...
                    if (t) {
                        const { left: i, top: a } = t.getBoundingClientRect(),
                            { clientX: s, clientY: o } = 'ontouchstart' in window && e.touches ? e.touches[0] : e;
                ...
                P = (e) => {
                    c.value.dragging && d('resized', { event: e }, !0),
                        (c.value.mouseDown = !1),
                ...
                A = (e, n) => {
                    'ontouchstart' in window &&
                        ...
                        f.value.splitter === n
                            ...
                            : ((f.value.splitter = n),
                              (f.value.timeoutId = setTimeout(() => (f.value.splitter = null), 500)))),
                        c.value.dragging ||
                            d(
                                'splitter-click',
                                {
                ...
                U = (e, n) => {
                    if (
                        ...
                        let t = 0;
                        (l.value = l.value.map(
                            (i, a) => ((i.size = a === n ? i.max : i.min), a !== n && (t += i.min), i)
                        )),
                            (l.value[n].size -= t),
                            d('pane-maximize', {
                                event: e,
                ...
                I = (e) => {
                    const n = x.value.getBoundingClientRect(),
                        { clientX: t, clientY: i } = 'ontouchstart' in window && e.touches ? e.touches[0] : e;
                    return {
                ...
                K = (e) => {
                    ...
                    if (H || ue) {
                        H
                            ? ((v.size = v.max),
                              (p.size = Math.max(100 - v.max - t.prevPanesSize - t.nextPanesSize, 0)))
                            : ((v.size = Math.max(100 - p.max - t.prevPanesSize - N(n + 1), 0)), (p.size = p.max));
                        return;
                    }
                    if (u.pushOtherPanes) {
                        const j = Q(t, s);
                    ...
                    v !== null &&
                        (v.size = Math.min(Math.max(s - t.prevPanesSize - t.prevReachedMinPanes, v.min), v.max)),
                        p !== null &&
                            (p.size = Math.min(
                                Math.max(100 - s - t.nextPanesSize - t.nextReachedMinPanes, p.min),
                                p.max
                            ));
                },
                Q = (e, n) => {
                    ...
                    return n < e.prevPanesSize + l.value[i[0]].min &&
                        ...
                        ? ((e.prevReachedMinPanes = 0),
                          ...
                          (l.value[i[1]].size =
                              100 - e.prevReachedMinPanes - l.value[0].min - e.prevPanesSize - e.nextPanesSize),
                          null)
                ...
                V = (e) => [...l.value].reverse().find((t) => t.index < e && t.size > t.min) || {},
                ...
                F = (e, n, t = !1) => {
                    ...
                    a.classList.add('splitpanes__splitter'),
                        t ||
                            ...
                            typeof window < 'u' && 'ontouchstart' in window && (a.ontouchstart = (s) => b(s, i)),
                            (a.onclick = (s) => A(s, i + 1))),
                ...
                C = () => {
                    ...
                    for (const i of e)
                        i.className.includes('splitpanes__pane') &&
                            (!n && u.firstSplitter ? F(n, i, !0) : n && F(n, i), n++);
                },
                ie = ({ uid: e, ...n }) => {
                    const t = M.value[e];
                ...
                te = (e) => {
                    ...
                    Array.from(((t = x.value) == null ? void 0 : t.children) || []).some(
                        (i) => (i.className.includes('splitpanes__pane') && n++, i.isSameNode(e.el))
                    ),
                        l.value.splice(n, 0, {
                            ...e,
                            index: n,
                ...
                le = () => {
                    ...
                    if (e > 0.1) {
                        for (const s of l.value)
                            s.givenSize === null && (s.size = Math.max(Math.min(e / (m.value - i), s.max), s.min)),
                                (a -= s.size);
                        a > 0.1 && q(a, n, t);
                    }
                },
                oe = ({ addedPane: e, removedPane: n } = {}) => {
                    ...
                    if (!(Math.abs(i) < 0.1)) {
                        for (const o of l.value)
                            ((e == null ? void 0 : e.givenSize) !== null && (e == null ? void 0 : e.id) === o.id) ||
                ...
                q = (e, n, t) => {
                    let i;
                    e > 0 ? (i = e / (m.value - n.length)) : (i = e / (m.value - t.length)),
                        l.value.forEach((a, s) => {
            ...
            return (
                ...
                (e, n) => (openBlock(), createBlock(resolveDynamicComponent(re)))
            );
        },
    },
    ge = {
    ...
    (function (global, factory) {
        ...
        function copyObj(obj, target, overwrite) {
            ...
            for (var prop$1 in obj)
                if (obj.hasOwnProperty(prop$1) && (overwrite !== false || !target.hasOwnProperty(prop$1)))
                    target[prop$1] = obj[prop$1];
            return target;
        }
        ...
        function getBidiPartAt(order, ch, sticky) {
            ...
            for (var i$3 = 0; i$3 < order.length; ++i$3) {
                ...
                if (cur.to == ch)
                    if (cur.from != cur.to && sticky == 'before') found = i$3;
                    else bidiOther = i$3;
                if (cur.from == ch)
                    if (cur.from != cur.to && sticky != 'before') found = i$3;
                    else bidiOther = i$3;
        ...
        var bidiOrdering = (function () {
            ...
            return function (str, direction) {
                ...
                for (var i$3$1 = 1, prev$1 = types[0]; i$3$1 < len - 1; ++i$3$1) {
                    ...
                    else if (type$2 == ',' && prev$1 == types[i$3$1 + 1] && (prev$1 == '1' || prev$1 == 'n'))
                        types[i$3$1] = prev$1;
                    prev$1 = type$2;
                }
        ...
        function getLine(doc$1, n) {
            n -= doc$1.first;
            if (n < 0 || n >= doc$1.size)
                throw new Error('There is no line ' + (n + doc$1.first) + ' in the document.');
            var chunk = doc$1;
            while (!chunk.lines)
                for (var i$3 = 0; ; ++i$3) {
                    var child = chunk.children[i$3],
                        sz = child.chunkSize();
                    if (n < sz) {
                        chunk = child;
                        break;
        ...
        function lineAtHeight(chunk, h$1) {
            ...
            outer: do {
                for (var i$1$1 = 0; i$1$1 < chunk.children.length; ++i$1$1) {
                    var child = chunk.children[i$1$1],
                        ch = child.height;
                    if (h$1 < ch) {
                        chunk = child;
                        continue outer;
        ...
        Context.fromSaved = function (doc$1, saved, line) {
            if (saved instanceof SavedContext)
                return new Context(doc$1, copyState(doc$1.mode, saved.state), line, saved.lookAhead);
        ...
        function highlightLine(cm, line, context, forceToEnd) {
            ...
            var loop = function (o$1) {
                ...
                var overlay = cm.state.overlays[o$1],
                    i$3 = 1,
                    at = 0;
                context.state = true;
                runMode(
        ...
        function getContextBefore(cm, n, precise) {
            ...
            var context = saved
                ? Context.fromSaved(doc$1, saved, start)
                : new Context(doc$1, startState(doc$1.mode), start);
        ...
        function extractLineClasses(type, output) {
            if (type)
                for (;;) {
                    ...
                    else if (!new RegExp('(?:^|\\s)' + lineClass[2] + '(?:$|\\s)').test(output[prop$1]))
                        output[prop$1] += ' ' + lineClass[2];
                }
            return type;
        }
        ...
        function findStartLine(cm, n, precise) {
            ...
            for (var search = n; search > lim; --search) {
                ...
                var line = getLine(doc$1, search - 1),
                    after = line.stateAfter;
                if (
                    after &&
                    (!precise || search + (after instanceof SavedContext ? after.lookAhead : 0) <= doc$1.modeFrontier)
                )
                    return search;
        ...
        function stretchSpansOverChange(doc$1, change) {
            ...
            if (first)
                for (var i$3 = 0; i$3 < first.length; ++i$3) {
                    var span = first[i$3];
                    if (span.to == null) {
            ...
            if (last)
                for (var i$1$1 = 0; i$1$1 < last.length; ++i$1$1) {
            ...
            if (!sameLine) {
                var gap = change.text.length - 2,
                    gapMarkers;
                if (gap > 0 && first) {
                    for (var i$2$1 = 0; i$2$1 < first.length; ++i$2$1)
                        if (first[i$2$1].to == null)
                            (gapMarkers || (gapMarkers = [])).push(new MarkedSpan(first[i$2$1].marker, null, null));
                }
        ...
        function removeReadOnlyRanges(doc$1, from, to) {
            ...
            doc$1.iter(from.line, to.line + 1, function (line) {
                if (line.markedSpans)
                    for (var i$4 = 0; i$4 < line.markedSpans.length; ++i$4) {
        ...
        function collapsedSpanAtSide(line, start) {
            var sps = sawCollapsedSpans && line.markedSpans,
                found;
            if (sps)
                for (var sp = void 0, i$3 = 0; i$3 < sps.length; ++i$3) {
                    sp = sps[i$3];
                    if (
                        sp.marker.collapsed &&
        ...
        function collapsedSpanAround(line, ch) {
            var sps = sawCollapsedSpans && line.markedSpans,
                found;
            if (sps)
                for (var i$3 = 0; i$3 < sps.length; ++i$3) {
                    var sp = sps[i$3];
                    if (
                        sp.marker.collapsed &&
        ...
        function lineIsHiddenInner(doc$1, line, span) {
            ...
            for (var sp = void 0, i$3 = 0; i$3 < line.markedSpans.length; ++i$3) {
                ...
                if (
                    ...
                    lineIsHiddenInner(doc$1, line, sp)
                )
                    return true;
            }
        }
        function heightAtLine(lineObj) {
            ...
            for (var p = chunk.parent; p; chunk = p, p = chunk.parent)
                for (var i$1$1 = 0; i$1$1 < p.children.length; ++i$1$1) {
        ...
        function buildLineContent(cm, lineView) {
            ...
            for (var i$3 = 0; i$3 <= (lineView.rest ? lineView.rest.length : 0); i$3++) {
                var line = i$3 ? lineView.rest[i$3 - 1] : lineView.line,
                    order = void 0;
                builder.pos = 0;
        ...
        function insertLineContent(line, builder, styles) {
            var spans = line.markedSpans,
                ...
                at = 0;
            if (!spans) {
                for (var i$1$1 = 1; i$1$1 < styles.length; i$1$1 += 2)
                    builder.addToken(
                        builder,
                        allText.slice(at, (at = styles[i$1$1])),
                        interpretTokenStyle(styles[i$1$1 + 1], builder.cm.options)
                    );
                return;
            }
        ...
        function insertLineWidgets(cm, lineView, dims) {
            ...
            if (lineView.rest)
                for (var i$3 = 0; i$3 < lineView.rest.length; i$3++)
                    insertLineWidgetsFor(cm, lineView.rest[i$3], lineView, dims, false);
        }
        ...
        function mapFromLineView(lineView, line, lineN) {
            ...
            if (lineView.rest) {
                for (var i$3 = 0; i$3 < lineView.rest.length; i$3++)
                    if (lineView.rest[i$3] == line)
                        return {
                            map: lineView.measure.maps[i$3],
                            cache: lineView.measure.caches[i$3],
                        };
                for (var i$1$1 = 0; i$1$1 < lineView.rest.length; i$1$1++)
                    if (lineNo(lineView.rest[i$1$1]) > lineN)
                        return {
            ...
            for (var i$3 = 0; i$3 < map$1.length; i$3 += 3) {
                ...
                if (start != null) {
                    ...
                    if (bias == 'left' && start == 0)
                        while (i$3 && map$1[i$3 - 2] == map$1[i$3 - 3] && map$1[i$3 - 1].insertLeft) {
                            node = map$1[(i$3 -= 3) + 2];
                            collapse = 'left';
                        }
                    if (bias == 'right' && start == mEnd - mStart)
                        while (
                            i$3 < map$1.length - 3 &&
                            map$1[i$3 + 3] == map$1[i$3 + 4] &&
                            !map$1[i$3 + 5].insertLeft
                        ) {
                            node = map$1[(i$3 += 3) + 2];
                            collapse = 'right';
                        }
        ...
        function getUsefulRect(rects, bias) {
            ...
            if (bias == 'left') {
                ...
                for (var i$1$1 = rects.length - 1; i$1$1 >= 0; i$1$1--)
                    if ((rect = rects[i$1$1]).left != rect.right) break;
            return rect;
        }
        ...
        function clearLineMeasurementCacheFor(lineView) {
            if (lineView.measure) {
                ...
                if (lineView.rest)
                    for (var i$3 = 0; i$3 < lineView.rest.length; i$3++) lineView.measure.caches[i$3] = {};
            }
        }
        ...
        function pageScrollX(doc$1) {
            if (chrome && android)
                return -(doc$1.body.getBoundingClientRect().left - parseInt(getComputedStyle(doc$1.body).marginLeft));
            return doc$1.defaultView.pageXOffset || (doc$1.documentElement || doc$1.body).scrollLeft;
        }
        function pageScrollY(doc$1) {
            if (chrome && android)
                return -(doc$1.body.getBoundingClientRect().top - parseInt(getComputedStyle(doc$1.body).marginTop));
        ...
        function widgetTopHeight(lineObj) {
            ...
            var height = 0;
            if (widgets) {
                for (var i$3 = 0; i$3 < widgets.length; ++i$3)
                    if (widgets[i$3].above) height += widgetHeight(widgets[i$3]);
            }
            return height;
        }
        ...
        function coordsChar(cm, x, y) {
            ...
            var lineN = lineAtHeight(doc$1, y),
                last = doc$1.first + doc$1.size - 1;
            if (lineN > last)
                return PosWithInfo(doc$1.first + doc$1.size - 1, getLine(doc$1, last).text.length, null, 1, 1);
            if (x < 0) x = 0;
            ...
            if (boxAround) {
                ...
                sticky =
                    ch == 0
                        ...
                        : ch == lineObj.text.length
                          ? 'before'
                          : measureCharPrepared(cm, preparedMeasure, ch - (ltr ? 1 : 0)).bottom + widgetHeight$1 <= y ==
                              ltr
                            ? 'after'
                            : 'before';
        ...
        function coordsBidiPart(cm, lineObj, lineNo$1, preparedMeasure, order, x, y) {
            var index = findFirst(
                function (i$3) {
                    var part$1 = order[i$3],
                        ltr$1 = part$1.level != 1;
                    return boxIsAfter(
                        cursorCoords(
                            cm,
                            Pos(lineNo$1, ltr$1 ? part$1.to : part$1.from, ltr$1 ? 'before' : 'after'),
                            'line',
                            lineObj,
                            preparedMeasure
                        ),
        ...
        function estimateHeight(cm) {
            ...
            return function (line) {
                ...
                var widgetsHeight = 0;
                if (line.widgets) {
                    for (var i$3 = 0; i$3 < line.widgets.length; i$3++)
                        if (line.widgets[i$3].height) widgetsHeight += line.widgets[i$3].height;
                }
        ...
        function drawSelectionCursor(cm, head, output) {
            ...
            if (pos.other) {
                var otherCursor = output.appendChild(
                    elt('div', '\xA0', 'CodeMirror-cursor CodeMirror-secondarycursor')
                );
        ...
        function drawSelectionRange(cm, range$1, output) {
            ...
            if (sFrom.line == sTo.line) drawForLine(sFrom.line, sFrom.ch, sTo.ch);
                ...
                var fromLine = getLine(doc$1, sFrom.line),
                    toLine = getLine(doc$1, sTo.line);
        ...
        function visibleLines(display, doc$1, viewport) {
            ...
            var from = lineAtHeight(doc$1, top),
                to = lineAtHeight(doc$1, bottom);
        ...
        function maybeScrollWindow(cm, rect) {
            ...
            else if (rect.bottom + box.top > (doc$1.defaultView.innerHeight || doc$1.documentElement.clientHeight))
                doScroll = false;
        ...
        function updateScrollbars(cm, measure) {
            ...
            for (
                var i$3 = 0;
                (i$3 < 4 && startWidth != cm.display.barWidth) || startHeight != cm.display.barHeight;
                i$3++
            ) {
        ...
        function endOperation_finish(op) {
            ...
            if (op.scrollToPos) {
                var rect = scrollPosIntoView(
                    cm,
                    clipPos(doc$1, op.scrollToPos.from),
                    clipPos(doc$1, op.scrollToPos.to),
            ...
            if (hidden) {
                for (var i$3 = 0; i$3 < hidden.length; ++i$3)
                    if (!hidden[i$3].lines.length) signal(hidden[i$3], 'hide');
            }
            if (unhidden) {
                for (var i$1$1 = 0; i$1$1 < unhidden.length; ++i$1$1)
                    if (unhidden[i$1$1].lines.length) signal(unhidden[i$1$1], 'unhide');
            }
        ...
        function highlightWorker(cm) {
            ...
            doc$1.iter(context.line, Math.min(doc$1.first + doc$1.size, cm.display.viewTo + 500), function (line) {
                if (context.line >= cm.display.viewFrom) {
                    ...
                    var resetState =
                        line.text.length > cm.options.maxHighlightLength ? copyState(doc$1.mode, context.state) : null;
                    ...
                    for (var i$3 = 0; !ischange && i$3 < oldStyles.length; ++i$3)
                        ischange = oldStyles[i$3] != line.styles[i$3];
        ...
        function restoreSelection(snapshot) {
            ...
            if (
                ...
                var sel = doc$1.defaultView.getSelection(),
                    range$1 = doc$1.createRange();
        ...
        function maybeUpdateLineNumberWidth(cm) {
            ...
            var doc$1 = cm.doc,
                last = lineNumberFor(cm.options, doc$1.first + doc$1.size - 1),
                display = cm.display;
        ...
        Selection.prototype.equals = function (other) {
            ...
            for (var i$3 = 0; i$3 < this.ranges.length; i$3++) {
                var here = this.ranges[i$3],
                    there = other.ranges[i$3];
        ...
        Selection.prototype.deepCopy = function () {
            var out = [];
            for (var i$3 = 0; i$3 < this.ranges.length; i$3++)
                out[i$3] = new Range(copyPos(this.ranges[i$3].anchor), copyPos(this.ranges[i$3].head));
        ...
        function computeReplacedSel(doc$1, changes, hint) {
            ...
            for (var i$3 = 0; i$3 < changes.length; i$3++) {
                ...
                if (hint == 'around') {
                    var range$1 = doc$1.sel.ranges[i$3],
                        inv = cmp(range$1.head, range$1.anchor) < 0;
        ...
        function isWholeLineUpdate(doc$1, change) {
            return (
                ...
                change.to.ch == 0 &&
                lst(change.text) == '' &&
                (!doc$1.cm || doc$1.cm.options.wholeLineUpdateBefore)
            );
        }
        function updateDoc(doc$1, change, markedSpans, estimateHeight$1) {
            ...
            function linesFor(start, end) {
                var result = [];
                for (var i$3 = start; i$3 < end; ++i$3)
                    result.push(new Line(text[i$3], spansFor(i$3), estimateHeight$1));
                return result;
            }
            var from = change.from,
                to = change.to,
                text = change.text;
            var firstLine = getLine(doc$1, from.line),
                lastLine = getLine(doc$1, to.line);
        ...
        function linkedDocs(doc$1, f, sharedHistOnly) {
            function propagate(doc$2, skip, sharedHist) {
                if (doc$2.linked)
                    for (var i$3 = 0; i$3 < doc$2.linked.length; ++i$3) {
                ...
                (hist.lastOp == opId ||
                    (hist.lastOrigin == change.origin &&
                        ...
                        ((change.origin.charAt(0) == '+' &&
                            hist.lastModTime > time - (doc$1.cm ? doc$1.cm.options.historyEventDelay : 500)) ||
                            change.origin.charAt(0) == '*'))) &&
        ...
        function selectionEventCanBeMerged(doc$1, origin, prev, sel) {
            ...
            return (
                ...
                (ch == '+' &&
                    ...
                    new Date() - doc$1.history.lastSelTime <= (doc$1.cm ? doc$1.cm.options.historyEventDelay : 500))
            );
        }
            ...
            if (
                ...
                (origin &&
                    ...
                    ((hist.lastModTime == hist.lastSelTime && hist.lastOrigin == origin) ||
                        selectionEventCanBeMerged(doc$1, origin, lst(hist.done), sel)))
            )
        ...
        function attachLocalSpans(doc$1, change, from, to) {
            var existing = change['spans_' + doc$1.id],
                n = 0;
        ...
        function removeClearedSpans(spans) {
            ...
            var out;
            for (var i$3 = 0; i$3 < spans.length; ++i$3)
                if (spans[i$3].marker.explicitlyCleared) {
        ...
        function copyHistoryArray(events, newGroup, instantiateSel) {
            ...
            for (var i$3 = 0; i$3 < events.length; ++i$3) {
                ...
                for (var j = 0; j < changes.length; ++j) {
                    ...
                    if (newGroup) {
                        for (var prop$1 in change)
                            if ((m = prop$1.match(/^spans_(\d+)$/))) {
        ...
        function extendSelections(doc$1, heads, options) {
            ...
            for (var i$3 = 0; i$3 < doc$1.sel.ranges.length; i$3++)
                out[i$3] = extendRange(doc$1.sel.ranges[i$3], heads[i$3], null, extend);
            ...
            var obj = {
                ...
                update: function (ranges) {
                    ...
                    for (var i$3 = 0; i$3 < ranges.length; i$3++)
                        this.ranges[i$3] = new Range(
                            clipPos(doc$1, ranges[i$3].anchor),
                            clipPos(doc$1, ranges[i$3].head)
                        );
                },
                origin: options && options.origin,
            };
        ...
        function setSelectionNoUndo(doc$1, sel, options) {
            if (
                hasHandler(doc$1, 'beforeSelectionChange') ||
                (doc$1.cm && hasHandler(doc$1.cm, 'beforeSelectionChange'))
            )
                sel = filterSelectionChange(doc$1, sel, options);
            ...
            if (!(options && options.scroll === false) && doc$1.cm && doc$1.cm.getOption('readOnly') != 'nocursor')
                ensureCursorVisible(doc$1.cm);
        }
        ...
        function skipAtomicInSelection(doc$1, sel, bias, mayClear) {
            ...
            for (var i$3 = 0; i$3 < sel.ranges.length; i$3++) {
                ...
                var newHead =
                    range$1.head == range$1.anchor
                        ? newAnchor
                        : skipAtomic(doc$1, range$1.head, old && old.head, bias, mayClear);
        ...
        function skipAtomicInner(doc$1, pos, oldPos, dir, mayClear) {
            var line = getLine(doc$1, pos.line);
            if (line.markedSpans)
                for (var i$3 = 0; i$3 < line.markedSpans.length; ++i$3) {
                    var sp = line.markedSpans[i$3],
                        m = sp.marker;
                    ...
                    if (
                        ...
                        if (oldPos) {
                            ...
                            if (dir < 0 ? preventCursorRight : preventCursorLeft)
                                near = movePos(doc$1, near, -dir, near && near.line == pos.line ? line : null);
                            if (
                                near &&
                                near.line == pos.line &&
                                ...
                                return skipAtomicInner(doc$1, near, pos, dir, mayClear);
                        }
                        var far = m.find(dir < 0 ? -1 : 1);
                        if (dir < 0 ? preventCursorLeft : preventCursorRight)
                            far = movePos(doc$1, far, dir, far.line == pos.line ? line : null);
        ...
        function skipAtomic(doc$1, pos, oldPos, bias, mayClear) {
            var dir = bias || 1;
            var found =
                skipAtomicInner(doc$1, pos, oldPos, dir, mayClear) ||
                (!mayClear && skipAtomicInner(doc$1, pos, oldPos, dir, true)) ||
                skipAtomicInner(doc$1, pos, oldPos, -dir, mayClear) ||
                (!mayClear && skipAtomicInner(doc$1, pos, oldPos, -dir, true));
            if (!found) {
                doc$1.cantEdit = true;
        ...
        function movePos(doc$1, pos, dir, line) {
            if (dir < 0 && pos.ch == 0)
                if (pos.line > doc$1.first) return clipPos(doc$1, Pos(pos.line - 1));
                else return null;
            else if (dir > 0 && pos.ch == (line || getLine(doc$1, pos.line)).text.length)
                if (pos.line < doc$1.first + doc$1.size - 1) return Pos(pos.line + 1, 0);
                else return null;
        ...
        function makeChange(doc$1, change, ignoreReadOnly) {
            ...
            if (split)
                for (var i$3 = split.length - 1; i$3 >= 0; --i$3)
                    makeChangeInner(doc$1, {
                        from: split[i$3].from,
                        to: split[i$3].to,
        ...
        function shiftDoc(doc$1, distance) {
            ...
            doc$1.sel = new Selection(
                map(doc$1.sel.ranges, function (range$1) {
                    return new Range(
                        Pos(range$1.anchor.line + distance, range$1.anchor.ch),
                        Pos(range$1.head.line + distance, range$1.head.ch)
                    );
                }),
                doc$1.sel.primIndex
            );
        ...
        function makeChangeSingleDoc(doc$1, change, selAfter, spans) {
            if (doc$1.cm && !doc$1.cm.curOp)
                return operation(doc$1.cm, makeChangeSingleDoc)(doc$1, change, selAfter, spans);
        ...
        TextMarker.prototype.clear = function () {
            ...
            if (cm && this.collapsed && !cm.options.lineWrapping)
                for (var i$1$1 = 0; i$1$1 < this.lines.length; ++i$1$1) {
                    var visual = visualLine(this.lines[i$1$1]),
        ...
        function markText(doc$1, from, to, options, type) {
            ...
            var marker = new TextMarker(doc$1, type),
                diff = cmp(from, to);
            ...
            if (marker.collapsed) {
                if (
                    conflictingCollapsedRange(doc$1, from.line, from, to, marker) ||
                    (from.line != to.line && conflictingCollapsedRange(doc$1, to.line, from, to, marker))
                )
            ...
            if (cm) {
                ...
                if (marker.collapsed) regChange(cm, from.line, to.line + 1);
                    ...
                    for (var i$3 = from.line; i$3 <= to.line; i$3++) regLineChange(cm, i$3, 'text');
        ...
        function markTextShared(doc$1, from, to, options, type) {
            ...
            var markers = [markText(doc$1, from, to, options, type)],
                primary = markers[0];
        ...
        function copySharedMarkers(doc$1, markers) {
            for (var i$3 = 0; i$3 < markers.length; i$3++) {
                var marker = markers[i$3],
                    pos = marker.find();
                var mFrom = doc$1.clipPos(pos.from),
                    mTo = doc$1.clipPos(pos.to);
                if (cmp(mFrom, mTo)) {
        ...
        Doc.prototype = createObj(BranchChunk.prototype, {
            ...
            setSelections: docMethodOp(function (ranges, primary, options) {
                ...
                for (var i$3 = 0; i$3 < ranges.length; i$3++)
                    out[i$3] = new Range(
                        clipPos(this, ranges[i$3].anchor),
                        clipPos(this, ranges[i$3].head || ranges[i$3].anchor)
                    );
                ...
                this.iter(from.line, to.line + 1, function (line) {
                    ...
                    if (spans)
                        for (var i$3 = 0; i$3 < spans.length; i$3++) {
                            ...
                            if (
                                !(
                                    (span.to != null && lineNo$1 == from.line && from.ch >= span.to) ||
            ...
            getAllMarks: function () {
                ...
                this.iter(function (line) {
                    ...
                    if (sps) {
                        for (var i$3 = 0; i$3 < sps.length; ++i$3)
                            if (sps[i$3].from != null) markers.push(sps[i$3].marker);
                    }
                });
                return markers;
            },
            ...
            unlinkDoc: function (other) {
                ...
                if (this.linked)
                    for (var i$3 = 0; i$3 < this.linked.length; ++i$3) {
            ...
            if (files && files.length && window.FileReader && window.File) {
                ...
                try {
                    ...
                    if (text$1) {
                        ...
                        if (selected)
                            for (var i$1$1 = 0; i$1$1 < selected.length; ++i$1$1)
                                replaceRange(cm.doc, '', selected[i$1$1].anchor, selected[i$1$1].head, 'drag');
        ...
        function deleteNearSelection(cm, compute) {
            ...
            runInOp(cm, function () {
                for (var i$4 = kill.length - 1; i$4 >= 0; i$4--)
                    replaceRange(cm.doc, '', kill[i$4].from, kill[i$4].to, '+delete');
        ...
        function moveVisually(cm, line, start, dir) {
            ...
            if (cm.doc.direction == 'rtl' || part.level == 1) {
                ...
                if (
                    ch != null &&
                    (!moveInStorageOrder
                        ? ch >= part.from && ch >= wrappedLineExtent$1.begin
                        : ch <= part.to && ch <= wrappedLineExtent$1.end)
                ) {
            ...
            var searchInVisualLine = function (partPos$1, dir$1, wrappedLineExtent$2) {
                var getRes = function (ch$2, moveInStorageOrder$2) {
                    return moveInStorageOrder$2
                        ? new Pos(start.line, mv(ch$2, 1), 'before')
                        : new Pos(start.line, ch$2, 'after');
                };
                for (; partPos$1 >= 0 && partPos$1 < bidi.length; partPos$1 += dir$1) {
                    ...
                    if (wrappedLineExtent$2.begin <= ch$1 && ch$1 < wrappedLineExtent$2.end)
                        return getRes(ch$1, moveInStorageOrder$1);
                }
            };
        ...
        var commands = {
            ...
            killLine: function (cm) {
                return deleteNearSelection(cm, function (range$1) {
                    if (range$1.empty()) {
                        ...
                        if (range$1.head.ch == len && range$1.head.line < cm.lastLine())
                            return {
                                from: range$1.head,
            ...
            newlineAndIndent: function (cm) {
                return runInOp(cm, function () {
                    ...
                    for (var i$3 = sels.length - 1; i$3 >= 0; i$3--)
                        cm.replaceRange(cm.doc.lineSeparator(), sels[i$3].anchor, sels[i$3].head, '+input');
                    sels = cm.listSelections();
                    for (var i$1$1 = 0; i$1$1 < sels.length; i$1$1++)
                        cm.indentLine(sels[i$1$1].from().line, null, true);
                    ensureCursorVisible(cm);
                });
            },
                ...
                if (behavior.unit == 'rectangle') {
                    ...
                    for (
                        ...
                        if (left == right) ranges$1.push(new Range(Pos(line, leftPos), Pos(line, leftPos)));
                            ...
                            ranges$1.push(new Range(Pos(line, leftPos), Pos(line, findColumn(text, right, tabSize))));
                    }
                    if (!ranges$1.length) ranges$1.push(new Range(start, start));
                    setSelection(
                        doc$1,
                        normalizeSelection(cm, startSel.ranges.slice(0, ourIndex).concat(ranges$1), ourIndex),
                        {
                            origin: '*mouse',
                            scroll: false,
                        }
        ...
        function defineOptions(CodeMirror$2) {
            ...
            function option(name, deflt, handle, notOnInit) {
                ...
                if (handle)
                    optionHandlers$1[name] = notOnInit
                        ? function (cm, val, old) {
            ...
            option('lineSeparator', null, function (cm, val) {
                ...
                for (var i$3 = newBreaks.length - 1; i$3 >= 0; i$3--)
                    replaceRange(cm.doc, val, newBreaks[i$3], Pos(newBreaks[i$3].line, newBreaks[i$3].ch + val.length));
            });
            option(
                'specialChars',
                /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b\u200e\u200f\u2028\u2029\u202d\u202e\u2066\u2067\u2069\ufeff\ufff9-\ufffc]/g,
        ...
        function CodeMirror$1(place, options) {
            ...
            if (typeof doc$1 == 'string')
                doc$1 = new Doc(doc$1, options.mode, null, options.lineSeparator, options.direction);
        ...
        function indentLine(cm, n, how, aggressive) {
            ...
            if (how == null) how = 'add';
            if (how == 'smart')
                if (!doc$1.mode.indent) how = 'prev';
                else state = getContextBefore(cm, n).state;
            var tabSize = cm.options.tabSize;
            var line = getLine(doc$1, n),
            ...
            if (how == 'prev')
                if (n > doc$1.first) indentation = countColumn(getLine(doc$1, n - 1).text, null, tabSize);
                else indentation = 0;
            ...
            if (cm.options.indentWithTabs)
                for (var i$3 = Math.floor(indentation / tabSize); i$3; --i$3) {
                    pos += tabSize;
                    indentString += '	';
                }
            ...
            if (indentString != curSpaceString) {
                ...
                for (var i$1$1 = 0; i$1$1 < doc$1.sel.ranges.length; i$1$1++) {
            ...
            if (paste && sel.ranges.length > 1) {
                if (lastCopied && lastCopied.text.join('\n') == inserted) {
                    if (sel.ranges.length % lastCopied.text.length == 0) {
                        multiPaste = [];
                        for (var i$3 = 0; i$3 < lastCopied.text.length; i$3++)
                            multiPaste.push(doc$1.splitLines(lastCopied.text[i$3]));
                    }
            ...
            for (var i$1$1 = sel.ranges.length - 1; i$1$1 >= 0; i$1$1--) {
                ...
                if (range$1.empty()) {
                    if (deleted && deleted > 0) from = Pos(from.line, from.ch - deleted);
                        ...
                        to = Pos(to.line, Math.min(getLine(doc$1, to.line).text.length, to.ch + lst(textLines).length));
                    else if (
                        paste &&
                        lastCopied &&
                        lastCopied.lineWise &&
        ...
        function addEditorMethods(CodeMirror$2) {
            ...
            CodeMirror$2.prototype = {
                ...
                setOption: function (option, value) {
                    ...
                    if (optionHandlers$1.hasOwnProperty(option))
                        operation(this, optionHandlers$1[option])(this, value, old);
                ...
                removeKeyMap: function (map$1) {
                    ...
                    for (var i$3 = 0; i$3 < maps.length; ++i$3)
                        if (maps[i$3] == map$1 || maps[i$3].name == map$1) {
                            maps.splice(i$3, 1);
                            return true;
                        }
                },
                ...
                indentSelection: methodOp(function (how) {
                    ...
                    for (var i$3 = 0; i$3 < ranges.length; i$3++) {
                        ...
                        if (!range$1.empty()) {
                            ...
                            if (from.ch == 0 && ranges.length == newRanges.length && newRanges[i$3].from().ch > 0)
                                replaceOneSelection(
                                    this.doc,
                                    i$3,
                                    new Range(from, newRanges[i$3].to()),
                                    sel_dontScroll
                                );
                ...
                getHelpers: function (pos, type) {
                    ...
                    if (typeof mode[type] == 'string') {
                        ...
                        for (var i$3 = 0; i$3 < mode[type].length; i$3++) {
                ...
                moveV: methodOp(function (dir, unit) {
                    ...
                    doc$1.extendSelectionsBy(function (range$1) {
                        ...
                        if (unit == 'page' && range$1 == doc$1.sel.primary())
                            addToScrollTop(this$1, charCoords(this$1, pos, 'div').top - headPos.top);
                        return pos;
                    }, sel_move);
                    if (goals.length)
                        for (var i$3 = 0; i$3 < doc$1.sel.ranges.length; i$3++)
                            doc$1.sel.ranges[i$3].goalColumn = goals[i$3];
                }),
                findWordAt: function (pos) {
                    var doc$1 = this.doc,
                        line = getLine(doc$1, pos.line).text;
                    var start = pos.ch,
                        end = pos.ch;
                    if (line) {
        ...
        function findPosH(doc$1, pos, dir, unit, visually) {
            ...
            function moveOnce(boundToLine) {
                ...
                if (next == null)
                    if (!boundToLine && findNextLine()) pos = endOfLine(visually, doc$1.cm, lineObj, pos.line, lineDir);
                    else return false;
                else pos = next;
                return true;
            }
        ...
        function findPosV(cm, pos, dir, unit) {
            ...
            if (unit == 'page') {
                var pageSize = Math.min(
                    ...
                    win(cm).innerHeight || doc$1(cm).documentElement.clientHeight
                );
    ...
    (function (mod) {
        ...
        CodeMirror$1.defineExtension('openDialog', function (template, callback, options) {
            ...
            if (inp) {
                ...
                if (options.onInput)
                    CodeMirror$1.on(inp, 'input', function (e) {
                        options.onInput(e, inp.value, close);
                    });
                if (options.onKeyUp)
                    CodeMirror$1.on(inp, 'keyup', function (e) {
                ...
                if (options.closeOnBlur !== false)
                    CodeMirror$1.on(dialog, 'focusout', function (evt) {
                ...
                var searchNext = function (query, event) {
                    ...
                    findNext(cm, event.shiftKey, function (_, to) {
                        ...
                        if (
                            ...
                            (hiding = dialog$1).style.opacity = 0.4;
                    });
                };
                persistentDialog(cm, getQueryDialog(cm), q, searchNext, function (event, query) {
                    var keyName = CodeMirror$1.keyName(event);
                    var extra = cm.getOption('extraKeys'),
                        cmd = (extra && extra[keyName]) || CodeMirror$1.keyMap[cm.getOption('keyMap')][keyName];
                    if (
                        cmd == 'findNext' ||
                        cmd == 'findPrev' ||
            ...
            cm.operation(function () {
                ...
                if (!cursor.find(rev)) {
                    cursor = getSearchCursor(
                        cm,
                        state.query,
                        rev ? CodeMirror$1.Pos(cm.lastLine()) : CodeMirror$1.Pos(cm.firstLine(), 0)
                    );
    ...
    (function (mod) {
        ...
        CodeMirror$1.defineMode('css', function (config, parserConfig) {
            ...
            var indentUnit = config.indentUnit,
                ...
                documentTypes$1 = parserConfig.documentTypes || {},
                mediaTypes$1 = parserConfig.mediaTypes || {},
                mediaFeatures$1 = parserConfig.mediaFeatures || {},
                mediaValueKeywords$1 = parserConfig.mediaValueKeywords || {},
                propertyKeywords$1 = parserConfig.propertyKeywords || {},
                nonStandardPropertyKeywords$1 = parserConfig.nonStandardPropertyKeywords || {},
                fontProperties$1 = parserConfig.fontProperties || {},
                counterDescriptors$1 = parserConfig.counterDescriptors || {},
                colorKeywords$1 = parserConfig.colorKeywords || {},
                valueKeywords$1 = parserConfig.valueKeywords || {},
            ...
            states.top = function (type$1, stream, state) {
                ...
                else if (supportsAtComponent && /@component/i.test(type$1))
                    return pushContext(state, stream, 'atComponentBlock');
                else if (/^@(-moz-)?document$/i.test(type$1)) return pushContext(state, stream, 'documentTypes');
                else if (/^@(media|supports|(-moz-)?document|import)$/i.test(type$1))
            ...
            states.prop = function (type$1, stream, state) {
                ...
                if (type$1 == 'hash' && !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(stream.current()))
                    override += ' error';
                ...
                if (type$1 == 'word') {
                    if (
                        (state.stateArg == '@font-face' &&
                            !fontProperties$1.hasOwnProperty(stream.current().toLowerCase())) ||
                        (state.stateArg == '@counter-style' &&
                            !counterDescriptors$1.hasOwnProperty(stream.current().toLowerCase()))
                    )
                        override = 'error';
        ...
        CodeMirror$1.simpleMode = function (config, states) {
            ...
            var mode = {
                ...
                copyState: function (state$1) {
                    ...
                    if (state$1.localState)
                        s.localState = CodeMirror$1.copyState(state$1.local.mode, state$1.localState);
                    if (state$1.stack) s.stack = state$1.stack.slice(0);
                    for (var pers = state$1.persistentStates; pers; pers = pers.next)
                        s.persistentStates = {
                            mode: pers.mode,
                            spec: pers.spec,
                            state:
                                pers.state == state$1.localState
                                    ? s.localState
                                    : CodeMirror$1.copyState(pers.mode, pers.state),
                ...
                blankLine: function (state) {
                    ...
                    if (!state.innerActive)
                        for (var i = 0; i < others.length; ++i) {
                            ...
                            if (other.open === '\n') {
                                state.innerActive = other;
                                state.inner = CodeMirror$1.startState(
                                    other.mode,
...
var require_xml = __commonJSMin((exports, module) => {
    (function (mod) {
        ...
        CodeMirror$1.defineMode('xml', function (editorConf, config_) {
            ...
            function attrState(type$1, _stream, state) {
                if (type$1 == 'word') {
                    ...
                    state.tagName = state.tagStart = null;
                    if (type$1 == 'selfcloseTag' || config.autoSelfClosers.hasOwnProperty(lower(tagName)))
        ...
        if (!CodeMirror$1.mimeModes.hasOwnProperty('text/html'))
            CodeMirror$1.defineMIME('text/html', {
                name: 'xml',
                htmlMode: true,
            });
    });
    ...
    (function (mod) {
        ...
        CodeMirror$1.defineMode('javascript', function (config, parserConfig) {
            ...
            function inScope(state, varname) {
                ...
                for (var cx$1 = state.context; cx$1; cx$1 = cx$1.prev)
                    for (var v = cx$1.vars; v; v = v.next) if (v.name == varname) return true;
            }
            ...
            return {
                ...
                indent: function (state, textAfter) {
                    ...
                    var type$1 = lexical.type,
                        closing = firstChar == type$1;
                    if (type$1 == 'vardef')
                        return (
                            lexical.indented +
    ...
    (function (mod) {
        ...
        CodeMirror$1.findModeByName = function (name) {
            ...
            for (var i$1 = 0; i$1 < CodeMirror$1.modeInfo.length; i$1++) {
                ...
                if (info$1.alias) {
                    for (var j = 0; j < info$1.alias.length; j++)
                        if (info$1.alias[j].toLowerCase() == name) return info$1;
                }
            }
        };
    });
            ...
            function (config) {
                ...
                State.prototype.copy = function () {
                    ...
                    if (this.innerMode && this.innerState)
                        res.innerState = CodeMirror$1.copyState(this.innerMode, this.innerState);
                ...
                function dot(stream, state) {
                    if (stream.eat('.')) {
                        ...
                        if (state.lastTag === 'script' && state.scriptType.toLowerCase().indexOf('javascript') != -1)
                            innerMode$1 = state.scriptType.toLowerCase().replace(/"|'/g, '');
                        ...
                        if (state.innerMode) {
                            if (!state.innerState)
                                state.innerState = state.innerMode.startState
                                    ? CodeMirror$1.startState(state.innerMode, stream.indentation())
                                    : {};
            ...
            function (config) {
                ...
                function buildStringTokenizer(quote, greedy) {
                    ...
                    function stringTokenizer(stream, state) {
                        ...
                        var endingString =
                            (nextChar !== '\\' && peekChar === quote) || (nextChar === quote && previousChar !== '\\');
                        if (endingString) {
        ...
        CodeMirror$1.defineMode('coffeescript', function (conf, parserConf) {
            ...
            function tokenFactory(delimiter, singleline, outclass) {
                return function (stream, state) {
                    ...
                    if (singleline)
                        if (parserConf.singleLineStringErrors) outclass = ERRORCLASS;
    ...
    (function (mod) {
        ...
        CodeMirror$1.defineMode('stylus', function (config) {
            ...
            function typeIsBlock(type$1, stream) {
                return (
                    (endOfLine(stream) &&
                        (type$1 == '{' || type$1 == ']' || type$1 == 'hash' || type$1 == 'qualifier')) ||
                    type$1 == 'block-mixin'
                );
            }
            ...
            states.block = function (type$1, stream, state) {
                if (
                    (type$1 == 'comment' && startOfLine(stream)) ||
                    (type$1 == ',' && endOfLine(stream)) ||
                    type$1 == 'mixin'
                )
                ...
                if (/@(font-face|media|supports|(-moz-)?document)/.test(type$1))
            ...
            states.parens = function (type$1, stream, state) {
                ...
                if (type$1 && type$1.charAt(0) == '@' && wordIsProperty(stream.current().slice(1)))
                    override = 'variable-2';
                if (type$1 == 'word') {
                    var word = stream.current();
                    override = wordAsValue(word);
            ...
            states.keyframes = function (type$1, stream, state) {
                ...
                if (type$1 == 'unit' && /^[0-9]+\%$/.test(stream.current()))
            ...
            return {
                ...
                indent: function (state, textAfter, line) {
                    var cx = state.context,
                        ch$1 = textAfter && textAfter.charAt(0),
                        indent = cx.indent,
                    ...
                    if (
                        cx.prev &&
                        ((ch$1 == '}' && (cx.type == 'block' || cx.type == 'atBlock' || cx.type == 'keyframes')) ||
                            (ch$1 == ')' && (cx.type == 'parens' || cx.type == 'atBlock_parens')) ||
                            (ch$1 == '{' && cx.type == 'at'))
                    )
                        ...
                        if (
                            ...
                            indent = lineIndent;
                        else if (/(\.|#|:|\[|\*|&|>|~|\+|\/)/.test(ch$1) || wordIsTag(lineFirstWord))
...
var require_vue = __commonJSMin((exports, module) => {
    (function (mod) {
        ...
        CodeMirror$1.defineMode('vue-template', function (config, parserConfig) {
            ...
            return CodeMirror$1.overlayMode(
                CodeMirror$1.getMode(config, parserConfig.backdrop || 'text/html'),
                mustacheOverlay
            );
        });
        CodeMirror$1.defineMode(
    ...
    const proxy$1 = new Proxy(target, {
        ...
        apply(_target, _thisArg, rawArgumentList) {
            ...
            if (last === createEndpoint)
                return requestResponseMessage(ep, pendingListeners, { type: 'ENDPOINT' }).then(fromWireValue);
    ...
    setup(__props) {
        ...
        return (_ctx, _cache) => {
            return (
                ...
                createBlock(
                    unref(Pe),
                    { onResize: _cache[0] || (_cache[0] = ($event) => onUpdate($event[0].size)) },
                    {
                        default: withCtx(() => [
                            withDirectives(
                                createVNode(
            ...
            return (
                ...
                createElementBlock(
                    ...
                    [
                        ...
                        props.line != null && props.column != null
                            ? (openBlock(),
                              createElementBlock(
                                  'span',
                                  _hoisted_3$2,
                                  ':' + toDisplayString(props.line) + ':' + toDisplayString(props.column),
                                  1
                              ))
                ...
                createElementBlock('div', _hoisted_1$1, [
                    _cache[0] ||
                        (_cache[0] = createBaseVNode(
                            ...
                            [createBaseVNode('div', { 'i-carbon:warning-square': '' }), createTextVNode(' Error ')],
                            -1
                        )),
                    ...
                    createBaseVNode('div', _hoisted_3$1, [
                        ...
                        createElementBlock(
                            Fragment,
                            null,
                            renderList(_ctx.error.stack, (item, idx) => {
                                return (
                                    openBlock(),
                                    createElementBlock(
                                        Fragment,
                                        ...
                                        [
                                            createBaseVNode(
                                                'div',
                                                _hoisted_4$1,
                                                toDisplayString(item.functionName || `(anonymous)`),
                                                1
                                            ),
                                            createBaseVNode('div', _hoisted_5$1, [
                                                createVNode(
                                                    _component_FilepathItem,
                                                    {
...
var module_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
    ...
    async setup(__props) {
        ...
        const info = ref(
            id.value
                ? (([__temp, __restore] = withAsyncContext(() => rpc.getModuleTransformInfo(payload.query, id.value))),
                  (__temp = await __temp),
                  __restore(),
                  __temp)
                : void 0
        ...
        const currentIndex = computed(
            () => (index.value != null ? +index.value : null) ?? (info.value?.transforms.length || 1) - 1
        );
        const deps = computed(() => {
        ...
        const sourcemaps = computed(() => {
            ...
            if (sourcemaps$1 && !sourcemaps$1.sourcesContent?.filter(Boolean)?.length)
                sourcemaps$1.sourcesContent = [from.value];
        ...
        getHot().then((hot) => {
            if (hot)
                hot.on('vite-plugin-inspect:update', ({ ids }) => {
                    ...
                    [
                        createVNode(_component_NavBar, null, {
                            default: withCtx(() => [
                                ...
                                unref(deps)?.length || unref(importers)?.length
                                    ? (openBlock(),
                                      createElementBlock(
                                          Fragment,
                                          { key: 1 },
                                                            ...
                                                            default: withCtx(() => [
                                                                createBaseVNode('button', _hoisted_1, [
                                                                    ...
                                                                    createBaseVNode(
                                                                        'span',
                                                                        _hoisted_2,
                                                                        toDisplayString(unref(deps).length),
                                                                        1
                                                                    ),
                                                                ]),
                                                            ]),
                                                            ...
                                                            default: withCtx(() => [
                                                                createBaseVNode('button', _hoisted_4, [
                                                                    ...
                                                                    createBaseVNode(
                                                                        'span',
                                                                        _hoisted_5,
                                                                        toDisplayString(unref(importers).length),
                                                                        1
                                                                    ),
                                                                ]),
                                                            ]),
                                ...
                                createBaseVNode(
                                    'button',
                                    {
                                        ...
                                        onClick:
                                            _cache[1] ||
                                            (_cache[1] = ($event) =>
                                                (unref(options).view.lineWrapping = !unref(options).view.lineWrapping)),
                                    },
                                    [
                                        createBaseVNode(
                                            'span',
                                            {
                                                ...
                                                class: normalizeClass(
                                                    unref(options).view.lineWrapping ? 'opacity-100' : 'opacity-25'
                                                ),
                                            },
                                            null,
                                            2
                                ...
                                createBaseVNode(
                                    'button',
                                    {
                                        ...
                                        onClick:
                                            _cache[2] ||
                                            (_cache[2] = ($event) =>
                                                (unref(options).view.showOneColumn =
                                                    !unref(options).view.showOneColumn)),
                                    },
                                    [
                                        unref(options).view.showOneColumn
                                ...
                                createBaseVNode(
                                    'button',
                                    {
                                        ...
                                        onClick:
                                            _cache[3] ||
                                            (_cache[3] = ($event) =>
                                                (unref(options).view.diff = !unref(options).view.diff)),
                                    },
                                    [
                                        createBaseVNode(
                                            'span',
                                            {
                                                'i-carbon-compare': '',
                                                class: normalizeClass(
                                                    unref(options).view.diff ? 'opacity-100' : 'opacity-25'
                                                ),
                                            },
                                            null,
                                            2
                                ...
                                !unref(payload).isStatic
                                    ? (openBlock(),
                                      createElementBlock(
                                          ...
                                          _cache[12] ||
                                              (_cache[12] = [
                                                  createBaseVNode('span', { 'i-carbon-renew': '' }, null, -1),
                                              ])
                                      ))
                                    : createCommentVNode('', true),
                            ]),
                        ...
                        !unref(info)?.transforms.length
                            ? (openBlock(),
                              createElementBlock('div', _hoisted_10, [
                                  createBaseVNode('div', null, [
                                      _cache[15] ||
                                          (_cache[15] = createTextVNode('No transform data for this module in the ')),
                                      createVNode(
                                          _component_Badge,
                                          {
                            ...
                            : unref(info) && unref(filteredTransforms)
                              ? (openBlock(),
                                createBlock(
                                            ...
                                            createVNode(
                                                unref(Pe),
                                                {
                                                    ...
                                                    onResize:
                                                        _cache[7] ||
                                                        (_cache[7] = ($event) =>
                                                            (unref(options).view.panelSizeModule = $event[0].size)),
                                                },
                                                {
                                                    default: withCtx(() => [
                                                        createVNode(
                                                                ...
                                                                default: withCtx(() => [
                                                                    createBaseVNode('div', _hoisted_11, [
                                                                        createBaseVNode(
                                                                            'span',
                                                                            _hoisted_12,
                                                                            toDisplayString(unref(payload).query.env) +
                                                                                ' TRANSFORM STACK',
                                                                            1
                                                                        ),
                                                                        createBaseVNode(
                                                                                ...
                                                                                createBaseVNode(
                                                                                    'div',
                                                                                    {
                                                                                        class: normalizeClass(
                                                                                            unref(options).view
                                                                                                .showBailout
                                                                                                ? 'opacity-100 i-carbon-view'
                                                                                                : 'opacity-75 i-carbon-view-off'
                                                                                        ),
                                                                                    },
                                                                                    null,
                                                                                    2
                                                                    ...
                                                                    createElementBlock(
                                                                        Fragment,
                                                                        null,
                                                                        renderList(unref(filteredTransforms), (tr) => {
                                                                            return (
                                                                                openBlock(),
                                                                                createElementBlock(
                                                                                    'button',
                                                                                        ...
                                                                                        tr.order !== 'normal'
                                                                                            ? (openBlock(),
                                                                                              createBlock(
                                                                                                  ...
                                                                                                  {
                                                                                                      key: 3,
                                                                                                      title: tr.order.includes(
                                                                                                          '-'
                                                                                                      )
                                                                                                          ? `Using object hooks ${tr.order}`
                                                                                                          : tr.order,
                                                                                                      text: tr.order,
                                                                                                  },
                                                                                                  null,
                                                            ...
                                                            { 'min-size': '5' },
                                                            {
                                                                default: withCtx(() => [
                                                                    createBaseVNode('div', _hoisted_14, [
                                                                        unref(currentTransform)?.error
                                                                            ? (openBlock(),
                                                                              createBlock(
                                                                                  _component_ErrorDisplay,
                                                                                  {
                                                                                      key: `error-${unref(id)}`,
                                                                                      error: unref(currentTransform)
                                                                                          .error,
                                                                                  },
                                                                                  null,
                                                                                  8,
                                                                            ...
                                                                            : (openBlock(),
                                                                              createBlock(
                                                                                  _component_DiffEditor,
                                                                                  {
                                                                                      key: unref(id),
                                                                                      'one-column':
                                                                                          unref(options).view
                                                                                              .showOneColumn ||
                                                                                          !!unref(currentTransform)
                                                                                              ?.error,
                                                                                      diff:
                                                                                          unref(options).view.diff &&
                                                                                          !unref(currentTransform)
                                                                                              ?.error,
                                                                                      from: unref(from),
                                                                                      to: unref(to),
