                                    ...
                                    createBaseVNode('table', _hoisted_1, [
                                        createBaseVNode('thead', null, [
                                            ...
                                            createElementBlock(
                                                Fragment,
                                                null,
                                                renderList(unref(payload).instance.environments, (e) => {
                                                    return (
                                                        openBlock(),
                                                        createElementBlock(
                                                            'td',
                                        ...
                                        createBaseVNode('tbody', null, [
                                            ...
                                            createElementBlock(
                                                Fragment,
                                                null,
                                                renderList(unref(payload).instance.plugins, (p, idx) => {
                                                    return (
                                                        openBlock(),
                                                        createElementBlock('tr', { key: idx }, [
                                                            (openBlock(),
                                                            createBlock(resolveDynamicComponent(renderRow(idx)))),
                                                        ])
                                                    );
                                                }),
                                                128
